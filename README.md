...
> invoke __`account/create`__ [token_code, _co-holders..._]
- Create an account
...
> invoke __`account/suspend`__ [token_code]
- Suspend the PAOT

> invoke __`account/unsuspend`__ [token_code]
- Unsuspend the PAOT
...
> invoke __`balance/pending/withdraw`__ [pending_balance_id]
...
> invoke __`fee/prune`__ [token_code, ten_minutes_flag, _endtime_]
...
> invoke __`token/mint`__ [token_code, amount]
- Get the mintable amount and mint the amount.
- [amount] : big int
- If genesis account holders are more than 1, it creates a contract.

> invoke __`token/update`__ [token_code]
...
> invoke __`transfer`__ [sender, receiver, amount, _memo_, _pending_time_, _expiry_, _extra-signers..._]
...
> invoke __`pay`__ [sender, receiver, amount(+), _memo_, _expiry_]
...
> invoke __`pay/refund`__ [original_pay_key, amount(+), _memo_ ]
...
> invoke __`pay/prune`__ [token_code|address, ten_minutes_flag, _end_time_]
